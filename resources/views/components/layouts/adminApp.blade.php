<!DOCTYPE html>
@php
    $appLang = Session()->get("locale");
    App::setLocale($appLang);
@endphp
<html lang="{{ $appLang }}" class="{{ (Session()->get('dark_mode_system') == 1) ? 'dark' : '' }}">
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">

    <title>{{ __($title) . ' - ' . env('APP_NAME') ?? 'Page Title' }}</title>
...
<body class="dark:bg-gray-900">
        ...
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start">
                    ...
                    <a href="{{ route('app-dashboard') }}" class="flex ml-2 md:mr-24">
                        <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 80 80">
                            <path fill="#212528"
                                  d="M7.3 53.8h49.4c.8 0 1.4-.6 1.4-1.4v-33c0-.8-.6-1.4-1.4-1.4H7.3c-.7 0-1.3.6-1.3 1.4v33c0 .8.6 1.4 1.3 1.4M2 58.7C2 60.3 3.3 62 5 62h54c1.6 0 3-1.7 3-3.3z"/>
                        ...
                        <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">RD Started</span>
                    </a>
                ...
                <div class="flex items-center">
                    ...
                    {{-- Dark Model User --}}
                    @livewire('Admin\Settings\DarkMode')
                        ...
                        <div>
                            <button type="button"
                                ...
                                <img class="w-8 h-8 rounded-full"
                                     src="{{ (!is_null(Auth::user()->image)) ? Storage::url('public/' . Auth::user()->image) : Storage::url('assets/' . NAME_IMAGE_DEFULT) }}" alt="user photo">
                            </button>
                        </div>
                            ...
                            <ul class="py-1" role="none">
                                <li>
                                    <a href="#"
                                       ...
                                       role="menuitem">@lang('Dashboard')</a>
                                </li>
                                <li>
                                    <a href="#"
                                       class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white"
    ...
    <div class="flex pt-16 overflow-hidden dark:bg-gray-900">
        ...
        <aside id="sidebar" class="fixed top-0 left-0 z-20 flex flex-col flex-shrink-0 hidden w-64 h-full pt-16 font-normal duration-75 lg:flex transition-width"
               aria-label="Sidebar">
            <div
                        ...
                        <ul class="pb-2 space-y-2">
                            <li>
                                <form action="#" method="GET" class="lg:hidden">
                                    <label for="mobile-search" class="sr-only">@lang('Search')</label>
                                    <div class="relative">
                                        <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                   ...
                                   class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                                    <svg
                                        ...
                                        <path fill="currentColor"
                                              d="M5.615 20q-.666 0-1.14-.475Q4 19.051 4 18.385V12.25h6.5V20zm5.885 0v-7.75H20v6.135q0 .666-.475 1.14q-.474.475-1.14.475zM4 11.25V5.615q0-.666.475-1.14Q4.949 4 5.615 4h12.77q.666 0 1.14.475q.475.474.475 1.14v5.635z"/>
                                    </svg>
                                    <span class="ml-3" sidebar-toggle-item="">@lang('Dashboard')</span>
                                </a>
                            </li>
                            <li>
                                <button type="button"
                                    ...
                                    <span class="flex-1 ml-3 text-left whitespace-nowrap"
                                          sidebar-toggle-item="">@lang('Users')</span>
                                ...
                                <ul id="dropdown-layouts" class="hidden py-2 space-y-2">
                                    <li>
                                        <a href="{{ route('app-create-user') }}"
                                           class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">@lang('Create user')</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('app-users') }}"
                                           class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">@lang('Users')</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                <button type="button"
                                    ...
                                    <svg class="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor" d="M5.615 20q-.69 0-1.152-.462Q4 19.075 4 18.385V5.615q0-.69.463-1.152Q4.925 4 5.615 4h12.77q.69 0 1.152.463q.463.462.463 1.152v12.77q0 .69-.462 1.152q-.463.463-1.153.463zM7.5 16.5h6v-1h-6zm0-4h9v-1h-9zm0-4h9v-1h-9z"/></svg>
                            ...
                            <li>
                                <button type="button"
                                    ...
                                    <svg class="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor" d="M5.615 20q-.69 0-1.152-.462Q4 19.075 4 18.385V5.615q0-.69.463-1.152Q4.925 4 5.615 4h12.77q.69 0 1.152.463q.463.462.463 1.152v12.77q0 .69-.462 1.152q-.463.463-1.153.463zM7.5 16.5h6v-1h-6zm0-4h9v-1h-9zm0-4h9v-1h-9z"/></svg>
                                    <span class="flex-1 ml-3 text-left whitespace-nowrap"
                                          sidebar-toggle-item="">@lang('Articles')</span>
                                    <svg sidebar-toggle-item="" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd"
                                              d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                                ...
                                <ul id="dropdown-articles" class="hidden py-2 space-y-2">
                                    <li>
                                        <a href="{{ route('app-create-article') }}"
                                           class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">@lang('Create article')</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('app-articles') }}"
                                           class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">@lang('Articles')</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('app-articles-categories') }}"
                                           class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">@lang('Categories')</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li>
                                <a href="{{ route('app-settings') }}"
                                   class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 ">
                                    ...
                                    <span class="ml-3" sidebar-toggle-item="">@lang('Settings')</span>
                                </a>
                            </li>
                        </ul>
                        <div class="pt-2 space-y-2">
                            <a href="https://github.com/richarddev7/rd-started" target="_blank"
                            ...
                            <a href="https://flowbite.com/docs/components/alerts/" target="_blank"
                               class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                                ...
                                <span class="ml-3" sidebar-toggle-item="">@lang('Components')</span>
                            </a>
                            <a href="https://github.com/themesberg/flowbite-admin-dashboard/issues" target="_blank"
                               class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                                ...
                                <span class="ml-3" sidebar-toggle-item="">@lang('Support')</span>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                {{-- Language --}}
                @livewire('Admin\Settings\Language')
        ...
        <div id="main-content" class="relative w-full h-full overflow-y-auto lg:ml-64 dark:bg-gray-900">
            <main class="dark:bg-gray-900">
                ...
                {{-- Contenido del layout a renderizar --}}
                @yield('content')
                {{-- Contenido del layout a renderizar --}}
                {{--{{ $slot }} --}}
            ...
            <footer class="fixed bottom-0 z-10 left-0 w-full py-4 bg-gray-100 text-sm text-center text-gray-500 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                © 2024 <a href="https://richard-dev.net/" class="hover:underline" target="_blank">Richard-Dev.net</a>. All
                rights reserved.
            </footer>
        </div>
