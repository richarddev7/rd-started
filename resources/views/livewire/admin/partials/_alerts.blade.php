<div class="pt-4 basis-2/4">
    @if(session()->has('message'))

        @if(session('type') == 'notification')

            <div id="alert-notification" class="flex items-center p-4 mb-4 text-blue-800 rounded-lg bg-blue-50 border-2 border-blue-500 dark:bg-gray-800 dark:text-blue-400" role="alert">
        ...
        @elseif(session('type') == 'error')
            ...
            <div id="alert-error" class="flex items-center p-4 mb-4 text-red-800 rounded-lg bg-red-50 border-2 border-red-500 dark:bg-gray-800 dark:text-red-400" role="alert">
        ...
        @else
            ...
            <div id="alert-success" class="flex items-center p-4 mb-4 text-green-800 rounded-lg bg-green-50 border-2 border-green-500 dark:bg-gray-800 dark:text-green-400" role="alert">
                <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
